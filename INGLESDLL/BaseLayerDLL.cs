...
namespace InglesDLL
{
    ...
    public class BaseLayerDLL : BaseDLL 
    {
        private bool _ExistError;
        public bool ExistError
        {
            get { return _ExistError; }
            set { _ExistError = value; }
        }
        ...
        private Errores _CodeError;
        public Errores CodeError
        {
        ...
        /// </summary>
        public BaseLayerDLL(string pstrConn, TypeDataBase pTypeDB) : base(pstrConn, pTypeDB)
        {
